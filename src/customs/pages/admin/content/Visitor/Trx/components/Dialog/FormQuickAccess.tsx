        ...
        <Grid container spacing={2}>
          ...
          <Grid size={{ xs: 12 }}>
            <Box display="flex" alignItems="center" gap={0.5} mb={1}>
              <CustomFormLabel sx={{ mt: 0, mb: 0 }}>Host</CustomFormLabel>

              <Tooltip title="Select the host for this quick access request." arrow>
                <IconInfoCircle
                  fontSize="small"
                  style={{
                    cursor: 'pointer',
            ...
            <Autocomplete
              ...
              value={allVisitorEmployee?.find((item) => item.id === form.hostId) || null}
              onChange={(_, value) => handleChange('hostId', value?.id || '')}
              ListboxProps={{
                sx: {
                  maxHeight: 250,
                  overflowY: 'auto',
              ...
              renderInput={(params) => (
                <CustomTextField {...params} placeholder="Select Host" fullWidth />
              )}
            />
          </Grid>
