...
const VisitorInformationDetail: React.FC<Props> = ({
  invitationCode,
  handleChooseCard,
  visitor,
}) => {
            ...
            <Grid size={{ xs: 6, md: 6 }}>
              <Box display="flex" justifyContent="space-between" alignItems={'center'}>
                <Box display="flex" gap={2} alignItems={'center'}>
                  ...
                  >
                    <IconCards color="white" />
                  </Box>
                  <CustomFormLabel sx={{ mt: 0 }}>Card</CustomFormLabel>
                </Box>
...
export default VisitorInformationDetail;
