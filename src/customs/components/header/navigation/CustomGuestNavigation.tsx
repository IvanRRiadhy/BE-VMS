...
import CustomNavListing, { ItemDataCustomNavListing } from './CustomNavGuestListing';
import CustomSidebarItems, { ItemDataCustomSidebarItems } from './CustomSidebarGuestItem';
...
const CustomGuestNavigation: React.FC<CustomNavigationProps> = ({
...
export default CustomGuestNavigation;
