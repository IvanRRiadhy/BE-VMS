...
export type GetAllDriverPaginationResponse = {
  RecordsTotal: number;
...
export type GetAllDriverByIdResponse = {
  status: string;
  status_code: number;
  title: string;
  msg: string;
...
//DELETE
export type DeleteDriverResponse<T = any> = {
  status: string;
  status_code: number;
  title: string;
  msg: string;
...
export interface UploadImageDriverResponse {
  status: string;
  status_code: number;
  title: string;
  msg: string;
