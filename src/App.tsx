...
// //   useEffect(() => {
// //     setPageLoading(true);
// //     // simulasi waktu transisi antar halaman
...
// import { setClearTokenCallback } from './customs/api/interceptor';
// import { GroupRoleId } from './constant/GroupRoleId';
// import { RouteLoaderHandler } from './customs/contexts/RouteLoaderHandler';
// import { useGlobalLoading } from './customs/contexts/GlobalLoadingContext';
// import { ProtectedRoute } from './customs/contexts/ProtectedRoute';

// ✅ lazy load semua halaman besar
...
const UnauthorizedPage = Loadable(lazy(() => import('./customs/components/page/UnauthorizedPage')));
...
//         <Suspense
//           fallback={
//             // <Backdrop open sx={{ color: '#1976d2', zIndex: 9999, bgcolor: 'rgba(255,255,255)' }}>
//             //   <CircularProgress color="primary" />
//             // </Backdrop>
//             null
//           }
...
// /**
//  * App hanya berfungsi sebagai pembungkus global:
//  * Theme, Direction (RTL/LTR), dan CssBaseline
//  */
